...
if not os.path.isfile("ghc.zip"):
    urllib.request.urlretrieve("https://jeodpp.jrc.ec.europa.eu/ftp/jrc-opendata/GHSL//GHS_DUC_GLOBE_R2023A/V2-0/GHS_DUC_MT_GLOBE_R2023A_V2_0.zip", "ghc.zip")

if not os.path.isfile("../data/GHS_DUC_GLOBE_R2023A_V2_0.xlsx"):
    with zipfile.ZipFile("ghc.zip", 'r') as zip_ref:
